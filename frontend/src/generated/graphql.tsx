...
export type CreatePostMutation = { __typename?: 'Mutation', createPost: { __typename?: 'Post', id: number, createdAt: string, creatorID: number, updatedAt: string, title: string, text: string, points: number } };
